                ...
                if (variable.calculated) {
                    ...
                    for (let j=0; j<dependsOn.length; j++) {
                        ...
                        if (calcVarname == "formula") {
                            ...
                            depFilePath = config.dataPath + "/" + depFilePath + "/" + d + "_" + timeHelper.getTimeForFileName(this.dataSetCode, this.dataSet, fileTime) + ".grb2";
                    ...
                    if (!formula) {
                        ...
                        calculatedFilePath = config.dataPath + "/" + calculatedFilePath + "/" + varCode + "_" + timeHelper.getTimeForFileName(this.dataSetCode, this.dataSet, fileTime) + ".grb2";
                        await gdal.translate(calculatedTIFF, calculatedFilePath, null, null, false);
